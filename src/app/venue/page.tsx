...
interface VenueDetails {
  ...
  address: string;
  mapsLink: string;
  embedSrc: string; // Must be a standard Google Maps embed URL (starts with https://www.google.com/maps/embed...)
  imageSrc: string;
}
...
const VENUES: VenueDetails[] = [
  ...
  },
  {
    ...
    imageSrc: "assets/reception.webp", // Update with your actual image path
  },
];
        ...
        {VENUES.map((venue, index) => (
          <div key={index} className="space-y-6">
            ...
            <SlideUp delay={index * 0.25}>
              <div className="bg-white rounded-2xl p-2 shadow-lg border border-muted overflow-hidden h-[250px]">
                <iframe 
                  src={venue.embedSrc} 
                  width="100%" 
                  height="100%" 
